...
[![Build status](https://github.com/dennisanand/ticket-check-action/workflows/CI/badge.svg)](https://github.com/dennisanand/ticket-check-action/actions)
  ...
  title:
    ...
    steps:
      - name: Check for ticket
        uses: dennisanand/ticket-check-action@v1
        with:
